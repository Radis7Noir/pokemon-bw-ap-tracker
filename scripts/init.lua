...
Tracker:AddItems("items/sanities/dexsanity_visibility.json")
Tracker:AddItems("items/sanities/dexsanity_sent.json")
Tracker:AddItems("items/sanities/seensanity_visibility.json")
Tracker:AddItems("items/sanities/seensanity_sent.json")
Tracker:AddItems("items/sanities/shinysanity_visibility.json")
...
-- Watches
ScriptHost:AddWatchForCode("goal", "goal_champion", toggle_goal)
ScriptHost:AddWatchForCode("goal2", "goal_cynthia", toggle_goal)
ScriptHost:AddWatchForCode("goal3", "goal_tmhm_hunt", toggle_goal)
ScriptHost:AddWatchForCode("goal4", "goal_seven_sages_hunt", toggle_goal)
